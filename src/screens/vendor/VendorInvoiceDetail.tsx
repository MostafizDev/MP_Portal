...
import { getInvoiceById, getOrderById } from '../../database/db';
    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <Card>
          ...
          <InfoRow label="Issued" value={fmtDateTime(invoice.issuedAt)} />
        ...
        {invoice.status === 'issued' && (
          <View style={[styles.notice, isOverdue ? styles.noticeOverdue : styles.noticePending]}>
            <Text style={[styles.noticeText, { color: isOverdue ? Colors.danger : Colors.warning }]}>
              {isOverdue
                ? `⚠️ This invoice is overdue! Due on ${new Date(invoice.dueDate).toLocaleDateString()}. Please contact your supplier.`
        ...
        {invoice.status === 'paid' && (
          <View style={styles.noticePaid}>
            <Text style={styles.noticePaidText}>✅ This invoice has been marked as paid. Thank you!</Text>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  itemTotal: { color: Colors.vendor, fontWeight: '700' },
  ...
  noticePaid: { backgroundColor: Colors.successBg, borderRadius: 12, padding: 14, borderWidth: 1, borderColor: Colors.success },
